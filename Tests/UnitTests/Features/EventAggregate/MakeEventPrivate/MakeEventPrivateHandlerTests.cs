...
public class MakeEventPrivateHandlerTests
{
    ...
    public async Task HandleAsync_WhenEventIsDraft_ReturnsSuccess()
    {
        ...
        var handler = new MakeEventPrivateHandler(new FakeVeaEventRepository(veaEvent), new FakeUnitOfWork());
    ...
    public async Task HandleAsync_WhenEventNotFound_ReturnsFailure()
    {
        ...
        var handler = new MakeEventPrivateHandler(new FakeVeaEventRepository(null), new FakeUnitOfWork());
